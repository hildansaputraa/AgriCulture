...
if (isset($_POST['edit_data'])) {
    ...
    if($_POST['password'] == ""){
        $sql_edit = "UPDATE user SET username = '$username', fullname = '$fullname', role = '$role', time = '$time' WHERE username = '$old_id'";
    } else {
        $password = password_hash($_POST['password'], PASSWORD_DEFAULT);
        $sql_edit = "UPDATE user SET username = '$username', password = '$password', fullname = '$fullname', role = '$role', time = '$time' WHERE username = '$old_id'";
    }
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item time">User</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                ...
                                <div class="from-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="time">
                                            <?php if ($data['time'] == "Yes") { ?>
                                            <option value="Yes">time</option>
                                            <option value="No">Intime</option>
                                            <?php } else { ?>
                                            <option value="No">Intime</option>
                                            <option value="Yes">time</option>
                                            <?php } ?>
